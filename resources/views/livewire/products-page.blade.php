                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(500, 'UDS') }}</span>
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(5000, 'UDS') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
